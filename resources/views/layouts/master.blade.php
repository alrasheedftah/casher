...
{{--    </form>--}}
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4" >
    ...
    <a href="index3.html" class="brand-link">
      <img src="image/logo.jpg" alt="Dashboard Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">فواكه طاعمة</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <!-- Sidebar Menu -->
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column " data-widget="treeview" role="menu" data-accordion="true" style="text-align: right">
          ...
          <li class="nav-item">
            <router-link to="/purches" class="nav-link">
              <i class="nav-icon fas fa-tachometer-alt orange"></i>
              <p>
                ادارة  المشتريات
              </p>
          ...
          <li class="nav-item">
            <router-link to="/casher" class="nav-link">
              <i class="nav-icon fas fa-tachometer-alt orange"></i>
              <p>
                الكاشير
              </p>
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2014-2019 <a href="https://adminlte.io">Jokers</a>.</strong> All rights Ana.
  </footer>
</div>
<!-- ./wrapper -->
